...
<head>
    ...
    <script>
        const validateForm = () => {
            ...
            if (!itemName || !itemDate || !itemLocation || !itemDescription || !itemImage) {
...
<body>
    ...
    <div class="container">
        <div class="submission-form">
            ...
            <hr>
            <form method="POST" action="?command=submit" enctype="multipart/form-data" onsubmit="validateForm">
                ...
                <div class="form-group">
                    ...
                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg status" name="status"
                        id="status">
                ...
                <div class="form-group">
                    ...
                    <textarea id="itemDescription" name="itemDescription" rows="3"
                        placeholder="Provide a brief description of the item"></textarea>
                </div>
                <div class="form-group">
